...
<div class="container-r flex-c">
        ...
        <div class="login-right box-s">
            ...
            <form id="registro-form" class="login-form flex-c" action="../controllers/registroController.php" method="POST"> <!-- Cambia la acción al controlador correspondiente -->
                 <div class="form-name">
                ...
                <?php if(!empty($errores['nombre'])): ?>
                    <p class="input-nombre-error input-registro-error"><?= $errores['nombre'] ?></p>
                <?php endif; ?>
                    <div class="input-div">
                ...
                <?php if(!empty($errores['correo'])): ?>
                    <p class="input-nombre-error input-registro-error"><?= $errores['correo'] ?></p>
                    <?php endif; ?>
                </div>
                ...
                <!-- Agregar esto después -->
                <?php if(!empty($errores['fNacimiento'])): ?>
                    <p class="input-nombre-error input-registro-error"><?= $errores['fNacimiento'] ?></p>
                <?php endif; ?>
                <div class="form-sexo">
                ...
                <div class="input-div">
                    ...
                    <?php if(!empty($errores['password'])): ?>
                        <p class="input-nombre-error input-registro-error"><?= $errores['password'] ?></p>
                    <?php endif; ?>
                </div>
                <div class="input-div">
                    <input id="password2" type="password" name="password2" placeholder="Confirmar Contraseña" />
                    <p class="input-password2-error input-error hidden">Las contraseñas no coinciden</p>
                </div>
