...
<div class="registro-container box-s flex-c">
    ...
    <form id="registro-form" class="registro-form flex-c" action="../controllers/registroController.php" method="POST">
        <div>
            ...
            <p class="input-nombre-error input-registro-error ">El nombre o apellido no es válido</p>
        </div>
        <div>
            <input type="email" name="email" placeholder="Correo" />
            <p class="input-email-error input-registro-error ">El correo no es válido</p>
            <?php 
        ...
        <div class="client-data">
            <div class="client-data-input form-peso">
                ...
                <p class="input-peso-error input-registro-error ">El peso introducido no es válido</p>
            </div>
            <div class="client-data-input form-altura">
                <label for="altura">Altura (cm)</label>
                <input type="number" name="altura" id="altura" placeholder="Altura" />
                <p class="input-altura-error input-registro-error ">La altura introducida no es válida</p>
            </div>
            <div class="client-data-input form-nacimiento">
                ...
                <p class="input-fNacimiento-error input-registro-error ">La fecha introducida no es válida</p>
            </div>
            <div class="client-data-input form-sexo">
                ...
                <p class="input-fNacimiento-error input-registro-error ">El sexo no es válido</p>
            </div>
        </div>
        <div class="client-data-checkbox flex-c">
            <div class="checkbox-container flex-c">
